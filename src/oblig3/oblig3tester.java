...
public class oblig3tester {
	...
	public static int oppgave2() {
		...
		if (tre.antall(7) != 1 || tre.antall(6) != 1 || tre.antall(5) != 1 || tre.antall(4) != 1 || tre.antall(3) != 1
				|| tre.antall(2) != 0 || tre.antall(1) != 7 || tre.antall(0) != 0) {
			antallFeil++;
	...
	public static int oppgave4() {
		...
		int[][] a = { { 1, 2, 3, 4, 5 }, { 5, 4, 3, 2, 1 }, { 4, 2, 5, 1, 3 }, { 2, 1, 4, 3, 5 }, { 1, 4, 2, 5, 3 },
				{ 4, 1, 5, 3, 2 } };
	...
	public static int oppgave7() {
		...
		if (!s[0].equals("[4, 1, 3, 2]") || !s[1].equals("[4, 6, 5]") || !s[2].equals("[4, 6, 8, 7]")
				|| !s[3].equals("[4, 6, 8, 9]")) {
			antallFeil++;
